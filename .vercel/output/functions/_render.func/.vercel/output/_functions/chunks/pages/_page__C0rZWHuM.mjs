...
import { $ as $$LinkButton, L as LOCALE, S as SITE, a as $$Header, b as $$Footer, c as $$Layout } from './404_BIx6mPod.mjs';
import 'clsx';
/* empty css                          */
/* empty css                          */
/* empty css                          */
...
}, "/Users/leojun/AstroPaper-blog/src/components/Breadcrumbs.astro", void 0);
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://gaazeon.com/", "ASSETS_PREFIX": undefined}, { _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/Tailscale Site to Site 异地组网.md": () => import('../Tailscale Site to Site 异地组网_jWmAQ8yI.mjs')});
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"tailscale-site-to-site-connect":"/src/content/blog/Tailscale Site to Site 异地组网.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/Tailscale Site to Site 异地组网.md": () => import('../Tailscale Site to Site 异地组网_DauLN_eh.mjs')});
...
}, "/Users/leojun/AstroPaper-blog/src/layouts/Main.astro", "self");
...
}, "/Users/leojun/AstroPaper-blog/src/components/Pagination.astro", void 0);
...
}, "/Users/leojun/AstroPaper-blog/src/layouts/TagPosts.astro", "self");
...
}, "/Users/leojun/AstroPaper-blog/src/pages/tags/[tag]/[page].astro", void 0);

const $$file = "/Users/leojun/AstroPaper-blog/src/pages/tags/[tag]/[page].astro";
