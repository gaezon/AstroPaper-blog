...
export default async post => {
  ...
  const titleText = rawTitle
    ...
    .replace(/[\u00A0\u202F\u2009\u200A\u2002\u2003\u2005]/g, " ")
    // Replace problematic Unicode hyphen/dash characters with standard hyphen-minus to avoid square box rendering
    // IBM Plex Sans and other fonts may not support all Unicode hyphen variants properly
    .replace(/[\u2010\u2011\u2012\u2013\u2014\u2015\u2212]/g, "\u002D")
