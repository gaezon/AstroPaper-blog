...
title: "TODO: Translate — Tailscale Site to Site 点对点两台 OpenWrt 异地组网教程"
featured: false
draft: true
tags:
  - tailscale
  - 网络
  - OpenWrt
description: "TODO: Translate — 本文详细介绍了如何使用 Tailscale 实现两台 OpenWrt
  软路由之间的异地组网，同时探讨 Tailscale
  的工作原理，以及如何配置和使用它来创建稳定、安全的异地组网环境，为那些希望在不同地点的设备之间建立网络连接的人们编写。"
locale: en
